...
set val(x)		300		   ;# horizontal dimension
set val(y)		300		   ;# vertical dimension
set val(nn)       	3                  ;# number of wireless nodes
set val(stop)		150.0		   ;# end time of simulation
set val(tr)		out2.tr	 	   ;# name of the trace file

# Network interface type for hidden node
...
proc finish {} {
for {set i 1} {$i <=3} {incr i 2} {
	exec rm -f out$i.xgr
 	exec awk -f fil$i.awk out2.tr > node_2.xgr
}

exec xgraph node_2.xgr &
